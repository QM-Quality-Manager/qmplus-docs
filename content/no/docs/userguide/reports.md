...
{{< figure src="/images/reports/reports_1_no.png" caption="Liste over sakerapporter" width="1024">}}

Å klikke på `Sakerapport`-lenken tar deg til listen over `Sakerapporter` i systemet.

### Forhåndsvisning
{{< figure src="/images/reports/reports_2_no.png" caption="Forhåndsvisning av sakerapport" width="1024">}}

Å klikke på `Forhåndsvisning` (øyesymbolet) i listen vil vise en forhåndsvisning av rapporten i skrivebeskyttet modus.

{{< figure src="/images/reports/reports_15_no.png" caption="Zoom inn på resultater" width="1024">}}
...
{{< figure src="/images/reports/reports_16_no.png" caption="Detaljer om grafsegment" width="1024">}}
...
{{< figure src="/images/reports/reports_3_no.png" caption="Redigering av rapport" width="1024">}}
...
{{< figure src="/images/reports/reports_4_no.png" caption="Generelle grafalternativer" width="1024">}}
...
{{< figure src="/images/reports/reports_6_no.png" caption="Redigering av filtre" width="1024">}}
...
{{< figure src="/images/reports/reports_7_no.png" caption="Forhåndsdefinerte grafer" width="1024">}}
...
{{< figure src="/images/reports/reports_9_no.png" caption="Liste over risikorapporter" width="1024">}}
...
{{< figure src="/images/reports/reports_8_no.png" caption="Forhåndsvisning av risikorapport" width="1024">}}
...
{{< figure src="/images/reports/reports_11_no.png" caption="Redigering av risikorapport" width="1024">}}
...
{{< figure src="/images/reports/reports_13_no.png" caption="Legg til risikoelement: Risikomodell" width="1024">}}
...
{{< figure src="/images/reports/reports_14_no.png" caption="Legg til risikoelement: Graf" width="1024">}}
